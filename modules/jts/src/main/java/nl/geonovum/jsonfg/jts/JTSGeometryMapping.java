package nl.geonovum.jsonfg.jts;

import java.util.Arrays;
import java.util.stream.IntStream;
import java.util.stream.Stream;
import nl.geonovum.jsonfg.core.GeometryMapping;
...
public class JTSGeometryMapping implements GeometryMapping<org.locationtech.jts.geom.Geometry> {
  ...
  public Geometry mapInstance(org.locationtech.jts.geom.Geometry geometry, CompatibilityMode compatibilityMode) {
    if (geometry instanceof Point point) {
      return nl.geonovum.jsonfg.model.Point.builder()
    ...
    if (geometry instanceof MultiPoint multiPoint) {
      return nl.geonovum.jsonfg.model.MultiPoint.builder()
    ...
    if (geometry instanceof LineString lineString) {
      return nl.geonovum.jsonfg.model.LineString.builder()
    ...
    if (geometry instanceof MultiLineString multiLineString) {
      ...
      return nl.geonovum.jsonfg.model.MultiLineString.builder()
    ...
    if (geometry instanceof Polygon polygon) {
      return nl.geonovum.jsonfg.model.Polygon.builder()
    ...
    if (geometry instanceof MultiPolygon multiPolygon) {
      ...
      return nl.geonovum.jsonfg.model.MultiPolygon.builder()
